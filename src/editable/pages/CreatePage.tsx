    ...
    <EditableSiteShell>
      <main className="min-h-screen bg-[var(--editable-page-bg,#fff7ee)] text-[var(--editable-page-text,#2f1d16)]">
        <section className="mx-auto max-w-[var(--editable-container)] px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
          <div className="mx-auto max-w-3xl rounded-[2.8rem] border border-[var(--editable-border)] bg-white/75 p-6 shadow-[0_30px_90px_rgba(15,23,42,0.08)] backdrop-blur sm:p-10">
            <div className="mb-8">
              <p className="text-xs font-black uppercase tracking-[0.28em] opacity-55">{pagesContent.create.hero.badge}</p>
              <h1 className="mt-5 text-4xl font-black leading-[0.92] tracking-[-0.08em] sm:text-5xl">{pagesContent.create.hero.title}</h1>
              <p className="mt-4 max-w-xl text-base font-semibold leading-8 opacity-70">{pagesContent.create.hero.description}</p>
            </div>
